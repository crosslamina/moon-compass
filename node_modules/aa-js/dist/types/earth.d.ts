import { EclipticCoordinatesAtJulianDayWithEquinoxFunction, EclipticCoordinatesAtJulianDayFunction, EquatorialCoordinatesAtJulianDayWithObliquityFunction, EquatorialCoordinatesAtJulianDayFunction, QuantityAtJulianDayFunction, QuantityInArcSecondAtJulianDayFunction, QuantityInAstronomicalUnitAtJulianDayFunction, QuantityInDegreeAtJulianDayFunction, SingleCoordinateDegreeAtJulianDayWithEquinoxFunction } from './funcs';

export declare enum Obliquity {
    Mean = "Mean",
    True = "True"
}
export declare enum Equinox {
