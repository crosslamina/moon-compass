...
export declare const getCoefficientsB2: () => (PlanetCoefficient)[];
export declare const getCoefficientsB3: () => (PlanetCoefficient)[];
export declare const getCoefficientsB4: () => (PlanetCoefficient)[];
export declare const getCoefficientsB5: () => (PlanetCoefficient)[];
...
export declare const getCoefficientsR5: () => (PlanetCoefficient)[];
